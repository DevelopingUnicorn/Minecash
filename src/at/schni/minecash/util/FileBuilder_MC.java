...
public class FileBuilder_MC {

    private File f;
    private YamlConfiguration c;

    public FileBuilder_MC(String FilePath, String FileName) {
        f = new File(FilePath, FileName);
        c = YamlConfiguration.loadConfiguration(f);
    }

    public FileBuilder_MC setValue(String ValuePath, Object Value) {
